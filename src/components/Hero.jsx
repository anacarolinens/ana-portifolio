...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative mx-auto w-full max-w-screen-xl flex flex-col lg:flex-row justify-center items-center lg:items-start pt-[230px] pb-0 px-4 lg:px-6 overflow-hidden"
    >
      ...
      <div className="z-10 w-full lg:w-1/2 text-center lg:text-left px-4 lg:px-0 lg:mb-0 mb-25">
        ...
        <div className="flex justify-center lg:justify-start gap-6">
          <a
            href="#linkedin"
            className="flex items-center px-6 py-3 rounded-[9px] text-sm sm:text-[18px] font-normal text-white bg-[var(--color-hover-gray)] hover:bg-[var(--color-bg-button)] transition-colors duration-300"
          >
            <img
      ...
      <div className="relative w-full lg:w-1/2 flex justify-end">
        <figure className="hidden lg:block w-[300px] sm:w-[350px] md:w-[395px] h-auto transform -translate-y-8 mx-auto lg:mx-0 mb-8 lg:mb-0">
