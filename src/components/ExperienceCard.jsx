...
const ExperienceCard = ({ title, description, date }) => (
  <div className="w-66 bg-gradient-to-r from-[var(--color-bg-light)] to-[var(--color-bg-lighte)] backdrop-blur-md border border-[var(--color-border-gray)] rounded-lg shadow p-4 flex flex-col justify-between text-gray-800 h-95 pt-10 mt-16 duration-300 transition-transform hover:scale-110">
    {/* Logo */}
